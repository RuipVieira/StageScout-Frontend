...
<script>
    import HeaderComponent from '@/components/MasterPageComponents/HeaderComponent.vue'
    import FooterComponent from '@/components/MasterPageComponents/FooterComponent.vue'
