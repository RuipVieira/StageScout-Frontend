<template>
    <div class="page-content-container">
        <h1 class="mb-3 text-center">StageScout - Pesquisa de Eventos</h1>
        <div class="container">
            <form>
        ...
        data() {
            return {
                columns: [
                    ...
                    { title: 'A Decorrer', key: 'isFinished' },
                ],
                events: [
                    { nome: "Primavera Sound Porto 2025", location: 'Parque da Cidade - Porto, Portugal', startDate: '12/05/2025', endDate: '15/05/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
                    { nome: "NOS Alive 2025", location: 'Passeio Marítimo de Algés - Lisboa, Portugal', startDate: '10/07/2025', endDate: '13/07/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
                    { nome: "Primavera Sound Porto 2025", location: 'Parque da Cidade - Porto, Portugal', startDate: '12/06/2025', endDate: '15/06/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
                    { nome: "Primavera Sound Porto 2025", location: 'Parque da Cidade - Porto, Portugal', startDate: '12/06/2025', endDate: '15/06/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
                    { nome: "Primavera Sound Porto 2025", location: 'Parque da Cidade - Porto, Portugal', startDate: '12/06/2025', endDate: '15/06/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
                    { nome: "Primavera Sound Porto 2025", location: 'Parque da Cidade - Porto, Portugal', startDate: '12/06/2025', endDate: '15/06/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
                    { nome: "Primavera Sound Porto 2025", location: 'Parque da Cidade - Porto, Portugal', startDate: '12/06/2025', endDate: '15/06/2025', state: "A Preencher Cartaz", isFinished: "Sim" },
